 ...
 */
import { ConstructorParams, LLMClient } from "@/dist";
 ...
 */
export declare const initStagehand: ({ llmClient, domSettleTimeoutMs, logger, configOverrides, actTimeoutMs, useTextExtract, }: {
    llmClient: LLMClient;
